...
-- Quotient-level cancellation: canonical list representation may change,
-- but subtracting and re-adding the same term preserves polynomial value mod p.
theorem divcore_natmodeq_cancel (p x : Nat) (cur sub : List Nat)
  ...
  unfold NatModEq
  simp [Galoistools.gfAdd, Galoistools.gfSub, Galoistools.refPolyEval, Nat.mod_mod]
