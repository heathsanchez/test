...
def main():
    ...
    root_obs=env.reset()
    if root_obs.levels_completed!=level:
        raise RuntimeError('reset did not return Level2 root')
    root=sig(root_obs)
    ...
    with open('arc3_developmental_v10_resource_quotient_result.json','w') as f:
