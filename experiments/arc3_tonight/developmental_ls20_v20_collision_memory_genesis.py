...
def main():
    ...
    edges=defaultdict(dict); edge_first={}; state_visits=Counter({root:1})
    ...
    for step in range(1,500):
        ...
        if unknown:
            ...
            def score(a):
                ...
                return (0,state_visits[t],-P.rank(prev_action,a),a)
        ...
        if old is not None and old!=ns:
            ...
            with open('arc3_developmental_v20_collision_memory_result.json','w') as f:
