...
def evaluate(row,test):
    ...
    return {'kind':'NO_GOAL','goal':False,'actions':n}
...
def main():
    ...
    result={'classification':'ARC3_LEVEL4_GOAL_KERNEL_COLLISION_PROBE',
    ...
    with open(f'arc3_v31_goal_kernel_collision_probe_{SHARD}.json','w') as f:
