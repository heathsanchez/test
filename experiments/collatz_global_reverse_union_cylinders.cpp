...
int main(int argc,char**argv){
  ...
  std::cout<<"GLOBAL_REVERSE_UNION_START depth="<<DEPTH
  ...
  for(int depth=1;depth<=DEPTH;++depth){
    ...
    std::cout<<"GLOBAL_REVERSE_UNION_LEVEL depth="<<depth
             <<" parents="<<live.size()
  ...
  std::cout<<"GLOBAL_REVERSE_UNION_RESULT depth="<<DEPTH
           <<" macro_depth="<<MD<<" emax="<<EM
           <<" survivors="<<live.size()
  ...
  std::cout<<"FINAL_GATE=GLOBAL_REVERSE_UNION_D"<<DEPTH
           <<"_M"<<MD<<"_E"<<EM<<"\n";
}
