...
int main(int argc,char**argv){
  ...
  for(int depth=1;depth<=DEPTH;++depth){
    ...
    std::cout<<"UNLABELED_TRIE_QUOTIENT_LEVEL depth="<<depth
             <<" R="<<R
  ...
  std::cout<<"VERIFIED_UNLABELED_TERNARY_TRIE_SCOUT\n";
  std::cout<<"FINAL_GATE=UNLABELED_TRIE_QUOTIENT_D"<<DEPTH<<"_R"<<R<<"\n";
  return 0;
}
