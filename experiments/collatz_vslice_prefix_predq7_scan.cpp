...
// Generated by experiments/collatz_reverse_predecessor_tree.py --q 7.
// This table is the quotient of every nonredundant first-contracting reverse
// predecessor class through denominator 3^7.
static constexpr uint32_t PRED_MOD=2187;
static std::array<uint8_t,PRED_MOD> PRED_KILLED{};
static void init_pred_sieve(){
  ...
  if(n!=1013){std::cerr<<"PRED_SIEVE_CENSUS_MISMATCH\n";std::exit(7);}
}
