...
def compose_map(f, g):
    # program execution: f followed by g
...
def conjugate(p, c):
    ...
    # c^-1 ; p ; c under compose_map convention
...
def source_world():
    # No mathematical labels are exposed to the constructor.
...
def cyclic_world(k):
    ...
    # Two opaque generators produce many distinct programs while retaining a small latent state space.
