...
proof=r'''
/-! Proof bridge for the proof-lite algebra evaluator. -/
...
proof_text=prefix+proof
proofp=OUT/"Submission_algebra_prooflite_v22_proof.lean"
proofp.write_text(proof_text)
print(f"generated {proofp} bytes={len(proof_text.encode())}")
