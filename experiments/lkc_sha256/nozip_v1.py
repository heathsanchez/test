...
/-- Consume round constants and message words in parallel without allocating K.zip schedule. -/
...
theorem fastStepNoZip_fun : fastStepNoZip = sha256step :=
  funext fastStepNoZip_correct

def impl (n : Nat) : Nat :=
  encodeDigest
    (iterDigest fastStepNoZip (sha256Steps n) (seedDigest (sha256Seed n)))
