#!/usr/bin/env python3
"""Frozen V17 universal-code stochastic readout learner."""
...
class Kernel:
    ...
    def _model_code_bits(m: int, k: int) -> float:
        # Encode subset size uniformly, then subset identity uniformly.
        return math.log2(m + 1) + math.log2(math.comb(m, k))
