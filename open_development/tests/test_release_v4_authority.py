...
class AuthorityTests(unittest.TestCase):
 def test_regression_binding_fails_closed(self):
  ...
  try:
   ...
   regression={"source_commit":"b"*40,"checkout_merge_commit":"a"*40,"run_id":1,"core_result":"RELEASE_EVIDENCE_PASS","core_evidence_digest":"c"*64,"semantics_result":"TYPED_PROGRAM_SEMANTICS_LEAN_PASS","axioms_pass_count":11,"artifact_digests":["sha256:"+"d"*64]}
