...
p=Path('scripts/run_developmental_distinction_discovery_v18.py')
s=p.read_text()
...
"""
if old not in s: raise SystemExit('V18 panic-location anchor missing')
p.write_text(s.replace(old,new,1))
print('patched V18 to structured common panic boundary')
