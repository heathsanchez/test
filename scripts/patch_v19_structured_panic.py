...
p=Path('scripts/run_developmental_distinction_invention_v19.py')
s=p.read_text()
...
"""
if old not in s: raise SystemExit('V19 panic-location anchor missing')
p.write_text(s.replace(old,new,1))
print('patched V19 to structured common panic boundary')
