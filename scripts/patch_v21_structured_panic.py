...
p=Path('scripts/run_developmental_distinction_quotient_v21.py')
s=p.read_text()
...
"""
if old not in s: raise SystemExit('V21 panic-location anchor missing')
p.write_text(s.replace(old,new,1))
print('patched V21 to structured common panic boundary')
