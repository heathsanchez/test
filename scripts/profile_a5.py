...
root = Path.cwd()
out = root / 'results/a5-profile'
out.mkdir(parents=True, exist_ok=True)
bin = root / 'a5/target/release/sokonanoda'
cfg = root / 'a5/config.json'
...
if bad:
    raise SystemExit('semantic failure in A5 profile')
