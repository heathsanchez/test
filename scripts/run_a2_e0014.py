...
root = Path.cwd()
out = root / 'results/a2-e0014-public'
...
paired=[(c-b)/b for b,c in zip(samples['a2'],samples['e0014'])]
summary={
  'substrate':{'sokonanoda':'9b4ea12f4cd437d00b6bcd0e34743065c58dea08','threads':4,'session_budget':2621440},
  'correctness':correctness,
  'median_seconds':med,
  'speedup_e0014_vs_a2':med['a2']/med['e0014'],
  'paired_fractional_change_e0014_minus_a2':paired,
