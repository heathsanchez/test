...
root = Path.cwd()
out = root / 'results/a3-e0024-protected'
...
# Same deterministic 24-case proxy, resource-measured under Arena-style PGO builds.
...
def paired(k): return [(b-a)/a for a,b in zip(vals('a3',k),vals('e0024',k))]
summary={
  'intervention':'bypass open-eval canonicalization/cache for App only',
  'substrate':{
    'sokonanoda':'9b4ea12f4cd437d00b6bcd0e34743065c58dea08',
    'threads':4,
    'session_budget':2621440,
    'a3':'E0018 apply_many transient prune removal',
  ...
  'wins':{k:sum(b<a for a,b in zip(vals('a3',k),vals('e0024',k))) for k in ('wall','cpu','rss_kb')}
}
