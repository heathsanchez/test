...
root = Path.cwd()
out = root / 'results/a4-e0025-protected'
...
def paired(k): return [(b-a)/a for a,b in zip(vals('a4',k),vals('e0025',k))]
summary={
  'intervention':'from A4, also bypass open-eval canonicalization/cache for Lambda',
  'substrate':{
    'sokonanoda':'9b4ea12f4cd437d00b6bcd0e34743065c58dea08',
    'threads':4,
    'session_budget':2621440,
    'a4':'E0018 transient prune removal + E0024 App open-cache bypass',
  ...
  'wins':{k:sum(b<a for a,b in zip(vals('a4',k),vals('e0025',k))) for k in ('wall','cpu','rss_kb')}
}
